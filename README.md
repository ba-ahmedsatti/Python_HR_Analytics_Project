...
Ahmed Satti
Introduction:
This capstone project aims to analyze HR data to provide actionable insights into employee turnover, recruitment efficiency, employee absence, and leadership impact. Using Python based data analytics, we explore trends to enhance decision making for MMZY Company.
